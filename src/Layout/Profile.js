...
const Profile = ({ layout, onLinkClicked }) => {
  ...
  const content = (
    <div>
      <a
        href
        onClick={(e) =>{ e.preventDefault(); onLinkClicked(`/${APP_PREFIX}/user/profile`);}}
      >
        <div>{t("header_profile_dropdown_my_profile")}</div>
      </a>
      {!AuthService.isTechnician() && (
        <a
          href
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          <div>{t("header_profile_dropdown_accounts_and_billing")}</div>
        </a>
      )}
      ...
      <a
        ...
        onClick={(e) =>{ 
          e.preventDefault(); 
          onLinkClicked(`/${APP_PREFIX}/user/change-password`); 
        }}
      >
        <div>{t("header_profile_dropdown_change_password")}</div>
      </a>
      {/* <a href="javascript:void(0)" onClick={() => onLinkClicked(`/${APP_PREFIX}/user/languages`)}>
      ...
      >
        <div style={{ color: "red" }}>
          {t("header_profile_dropdown_logout")}
        </div>
      </Link>
    </div>
  );
    ...
    <>
            ...
            <Avatar
              ...
              icon={
                (user && (
                  <img
                    src={
                      !user.profile_pic || user.profile_pic === "default"
                        ? AuthService.isTechnician()
                          ? technician_pic
                          : admin_pic
                  ...
                  <img
                    src={
                      !auth_user.profile_pic ||
                      auth_user.profile_pic === "default"
                        ? AuthService.isTechnician()
                          ? technician_pic
                          : admin_pic
                        : `${environment.PATH_PROFILE_PIC}/${
      ...
      {showAccountInfo && (
        ...
        >
          ...
          />
          <a href="https://www.servicevault.com/#/Pricing" target="_blank">
            Upgrade Package
          </a>
        </Modal>
      )}
