...
const Form_LeadSource = ({ form, showForm, recordToEdit, handleCancel, onFinish, onFinishFailed, ENTITY }) => {
  const { t } = useTranslation();
  const { curOrg: organisation } = useContext(Context);
  return (
    <Modal
      title={t("general_add_edit_lead_source")}
      visible={showForm}
      // onOk={handleSave}
    ...
    >
      ...
      >
        ...
        <Form.Item
          ...
          hasFeedback
        >
          <Input placeholder={t("general_name")} />
        </Form.Item>
...
export default Form_LeadSource;
