...
const Form_Discount_EmergencyRate = ({
  form,
  showForm,
  recordToEdit,
  handleCancel,
  ...
  return (
    <Modal
      title={t("general_add_edit_serv_em_rate")}
      visible={showForm}
      width={480}
      // onOk={handleSave}
      ...
      {recordToEdit && (
        ...
        >
          ...
          <Form.Item
            ...
            className="two-row-item"
            rules={[{ required: true, message: "Please select a job priority" }]}
          >
            <Select options={data.jobPriorities} />
          </Form.Item>
          <Form.Item
            name="rate_increase"
...
export default Form_Discount_EmergencyRate;
