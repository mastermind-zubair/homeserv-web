...
const Form_Discount_SpecialRateDiscount = ({
  form,
  showForm,
  recordToEdit,
  handleCancel,
  ...
  return (
    <Modal
      title={t("general_add_edit_sp_rate_dis")}
      visible={showForm}
      width={480}
      // onOk={handleSave}
      ...
      {recordToEdit && (
        ...
        >
          ...
          <Form.Item
            ...
            className="two-row-item"
            rules={[{ required: true, message: "Please select a discount tag" }]}
          >
            <Select multiple={false} options={data.discountTags} />
          </Form.Item>

          <Form.Item
            name="rate_discount"
            label={t("general_discount_rate")}
            className="two-row-item"
...
export default Form_Discount_SpecialRateDiscount;
