...
const { Modal, Form, Input, Radio, DatePicker, Upload } = require("antd");
const { LoadingPanelForPopup } = require("Layout/LoadingPanels");

const Form_Fleet_Vehicle = ({ form, showForm, recordToEdit, handleCancel, onFinish, onFinishFailed, ENTITY, dateFormat }) => {
  ...
  return (
    <Modal
      title={t("general_add_edit_new_veh")}
      visible={showForm}
      width={768}
      // onOk={handleSave}
    ...
    >
      ...
      >
        ...
        <Form.Item name="is_plant" initialValue={false} hidden />

        <Form.Item style={{ marginBottom: 0 }}>
          <Form.Item
            name="vehicle_type"
            label={t("quick_setup_sub_contractors_form_vehicle_type")}
        ...
        <Form.Item label="" style={{ marginBottom: 0 }}>
          <Form.Item
            name="policy_number"
            label={t("general_insurance_policy_#")}
            rules={[{ required: true, message: "policy number is required" }]}
            className="two-row-item"
          >
            <Input placeholder={t("general_policy_#")} />
          </Form.Item>
          <Form.Item
            name="policy_expiry"
        ...
        <Form.Item label="" style={{ marginBottom: 0 }}>
          <Form.Item
            name="plant_number"
            label={t("general_vehicle_number")}
          ...
          <Form.Item
            ...
            label={t("general_next_vehicle_service_date")}
        ...
        <Form.Item label={t("general_vehicle_photo")} name="vehicle_image">
          <div className="flex">
...
export default Form_Fleet_Vehicle;
