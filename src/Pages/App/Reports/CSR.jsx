...
const CSR = (props) => {
  ...
  const handleSearch = async () => {
    ...
    let { data, status, message } = await trackPromise(
      DefaultService.POST("/report/csr", {
        condition: {
    ...
    data.total_booked_by_stats =
      data &&
      data.total_booked_by_stats &&
      data.total_booked_by_stats.map((d) => {
        return { ...d, conversion_rate: "100%" };
      });
  ...
  const columns = [
    {
      caption: t("general_cs_representative"),
      dataField: "name",
      dataType: "string",
      alignment: "left",
    },
    {
      caption: t("general_total_jobs_booked"),
    ...
    {
      caption: t("general_total_job_value"),
    ...
    {
      caption: t("general_average_booked_job_value"),
      dataField: "avg_sales",
      dataType: "number",
      format: MoneyFormat,
      alignment: "left",
    ...
    {
      caption: t("general_call_conversion_rate"),
  ...
  return (
    <>
      ...
      <div className="flex mt-3">
        <CustomDataGrid
          data={data?.total_booked_by_stats}
          columns={columns}
          ENTITY={ENTITY}
