...
const SvApiUploader = ({ endpoint, fileType, sizeLimit, multiple, maxCount, onFileUploaded,onRemove,fileList=[] }) => {
  ...
  const uploadImage = async (options) => {
    ...
    try {
      ...
      notify("Failed to upload picture. " + (err.response && err.response.data), false);
      onError({ err });
    }
  };
