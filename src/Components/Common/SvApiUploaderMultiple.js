...
const SvApiUploaderMultiple = ({ files, endpoint, fileType, sizeLimit, multiple, maxCount, onFileUploaded }) => {
  const [defaultFileList, setDefaultFileList] = useState(files || []);
  ...
  return (
    <div className="flex">
      <Upload
        multiple={multiple}
        accept={
          fileType === "picture" ? "image/*" : fileType === "document" ? "application/*" : "image/*;application/*"
        }
...
export default SvApiUploaderMultiple;
